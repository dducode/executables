...
public static partial class Pipeline<T1, T4> {
  ...
  public static PipelineBuilder<T1, T2, T3, T4> Use<T2, T3>(Func<T1, ContextFunc<T2, T3>, T4> middleware) {
    ...
    return new PipelineBuilder<T1, T2, T3, T4>(new AnonymousMiddleware<T1, T2, T3, T4>((input, handler) => middleware(input, handler.Handle)));
  }
  ...
  public static PipelineBuilder<T1, Unit, T, T4> Use<T>(Func<T1, ContextFunc<T>, T4> middleware) {
    ...
    return new PipelineBuilder<T1, Unit, T, T4>(new AnonymousMiddleware<T1, Unit, T, T4>((input, handler) => {
      return middleware(input, init => handler.Handle(default, init));
    }));
  }
  ...
  public static PipelineBuilder<T1, T, Unit, T4> Use<T>(Func<T1, ContextAction<T>, T4> middleware) {
    ...
    return new PipelineBuilder<T1, T, Unit, T4>(new AnonymousMiddleware<T1, T, Unit, T4>((input, handler) => {
      return middleware(input, (i, init) => handler.Handle(i, init));
    }));
  }
...
public static partial class Pipeline<T> {
  ...
  public static PipelineBuilder<Unit, T1, T2, T> Use<T1, T2>(Func<ContextFunc<T1, T2>, T> middleware) {
    ExceptionsHelper.ThrowIfNull(middleware, nameof(middleware));
    return new PipelineBuilder<Unit, T1, T2, T>(new AnonymousMiddleware<Unit, T1, T2, T>((_, handler) => middleware(handler.Handle)));
  }
  ...
  public static PipelineBuilder<Unit, Unit, T1, T> Use<T1>(Func<ContextFunc<T1>, T> middleware) {
    ...
    return new PipelineBuilder<Unit, Unit, T1, T>(new AnonymousMiddleware<Unit, Unit, T1, T>((_, handler) => {
      return middleware(init => handler.Handle(default, init));
    }));
  }
  ...
  public static PipelineBuilder<Unit, T1, Unit, T> Use<T1>(Func<ContextAction<T1>, T> middleware) {
    ...
    return new PipelineBuilder<Unit, T1, Unit, T>(new AnonymousMiddleware<Unit, T1, Unit, T>((_, handler) => {
      return middleware((input, init) => handler.Handle(input, init));
    }));
  }
  ...
  public static PipelineBuilder<T, Unit, T1, Unit> Use<T1>(Action<T, ContextFunc<T1>> middleware) {
    ...
    return new PipelineBuilder<T, Unit, T1, Unit>(new AnonymousMiddleware<T, Unit, T1, Unit>((input, handler) => {
      middleware(input, init => handler.Handle(default, init));
      return default;
    }));
  }
  ...
  public static PipelineBuilder<T, T1, Unit, Unit> Use<T1>(Action<T, ContextAction<T1>> middleware) {
    ...
    return new PipelineBuilder<T, T1, Unit, Unit>(new AnonymousMiddleware<T, T1, Unit, Unit>((input, handler) => {
      middleware(input, (i, init) => handler.Handle(i, init));
      return default;
    }));
  }
...
public static partial class Pipeline {
  ...
  public static PipelineBuilder<Unit, Unit, T, Unit> Use<T>(Action<ContextFunc<T>> middleware) {
    ...
    return new PipelineBuilder<Unit, Unit, T, Unit>(new AnonymousMiddleware<Unit, Unit, T, Unit>((_, handler) => {
      middleware(init => handler.Handle(default, init));
      return default;
    }));
  }
  ...
  public static PipelineBuilder<Unit, T, Unit, Unit> Use<T>(Action<ContextAction<T>> middleware) {
    ...
    return new PipelineBuilder<Unit, T, Unit, Unit>(new AnonymousMiddleware<Unit, T, Unit, Unit>((_, handler) => {
      middleware((i, init) => handler.Handle(i, init));
      return default;
    }));
  }
