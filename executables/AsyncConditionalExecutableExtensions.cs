...
public static class AsyncConditionalExecutableExtensions {
  ...
  public static IAsyncExecutable<T1, Optional<T2>> OrWhen<T1, T2>(
    this IAsyncExecutable<T1, Optional<T2>> executable,
    ...
    return new AsyncOrWhenExecutable<T1, T2>(condition, executable, other);
  }
  ...
  public static IAsyncExecutable<T1, Optional<T2>> OrWhen<T1, T2>(
    ...
    ExceptionsHelper.ThrowIfNull(condition, nameof(condition));
    ExceptionsHelper.ThrowIfNull(other, nameof(other));
    return new AsyncOrWhenFlattenExecutable<T1, T2>(condition, executable, other);
  }

  /// <summary>
  /// Adds a conditional fallback executed with a synchronous executable when the source executable produces no value.
  /// </summary>
  /// <param name="executable">Source optional executable.</param>
  /// <param name="condition">Condition evaluated against the original input.</param>
  ...
  public static IAsyncExecutable<T1, Optional<T2>> OrWhen<T1, T2>(
    ...
    ExceptionsHelper.ThrowIfNull(other, nameof(other));
    return executable.OrWhen(condition, other.ToAsyncExecutable());
  }

  /// <summary>
  /// Adds a conditional fallback executed with a synchronous executable when the source executable produces no value and flattens an optional fallback result.
  /// </summary>
  /// <param name="executable">Source optional executable.</param>
  /// <param name="condition">Condition evaluated against the original input.</param>
  /// <param name="other">Executable to run when the condition is satisfied.</param>
  ...
  /// </exception>
  [Pure]
  public static IAsyncExecutable<Unit, Optional<T>> OrWhen<T>(this IAsyncExecutable<Unit, Optional<T>> executable, Func<bool> condition, AsyncFunc<T> other) {
    ExceptionsHelper.ThrowIfNull(condition, nameof(condition));
  ...
  /// </exception>
  [Pure]
  public static IAsyncExecutable<T, Optional<Unit>> OrWhen<T>(
    this IAsyncExecutable<T, Optional<Unit>> executable,
  ...
  /// </exception>
  [Pure]
  public static IAsyncExecutable<Unit, Optional<Unit>> OrWhen(
    this IAsyncExecutable<Unit, Optional<Unit>> executable,
    Func<bool> condition,
    AsyncAction other) {
    ExceptionsHelper.ThrowIfNull(condition, nameof(condition));
    return executable.OrWhen(_ => condition(), AsyncExecutable.Create(other));
  ...
  /// </exception>
  [Pure]
  public static IAsyncExecutable<Unit, Optional<T>> OrWhen<T>(this IAsyncExecutable<Unit, Optional<T>> executable, Func<bool> condition, Func<T> other) {
    ExceptionsHelper.ThrowIfNull(condition, nameof(condition));
  ...
  /// </exception>
  [Pure]
  public static IAsyncExecutable<T, Optional<Unit>> OrWhen<T>(this IAsyncExecutable<T, Optional<Unit>> executable, Func<T, bool> condition, Action<T> other) {
    ExceptionsHelper.ThrowIfNull(condition, nameof(condition));
    return executable.OrWhen(condition, Executable.Create(other));
  }
  ...
  /// </exception>
  [Pure]
  public static IAsyncExecutable<Unit, Optional<Unit>> OrWhen(this IAsyncExecutable<Unit, Optional<Unit>> executable, Func<bool> condition, Action other) {
    ExceptionsHelper.ThrowIfNull(condition, nameof(condition));
    return executable.OrWhen(_ => condition(), Executable.Create(other));
  }
  ...
  [Pure]
  public static IAsyncExecutable<T1, T2> OrElse<T1, T2>(this IAsyncExecutable<T1, Optional<T2>> executable, IAsyncExecutable<T1, T2> other) {
    executable.ThrowIfNullReference();
    ExceptionsHelper.ThrowIfNull(other, nameof(other));
    return new AsyncOrElseExecutable<T1, T2>(executable, other);
  }
  ...
  /// <exception cref="ArgumentNullException"><paramref name="other"/> is <see langword="null"/>.</exception>
  [Pure]
  public static IAsyncExecutable<T1, T2> OrElse<T1, T2>(this IAsyncExecutable<T1, Optional<T2>> executable, IExecutable<T1, T2> other) {
    ExceptionsHelper.ThrowIfNull(other, nameof(other));
    return executable.OrElse(other.ToAsyncExecutable());
  }
  ...
  /// <exception cref="ArgumentNullException"><paramref name="other"/> is <see langword="null"/>.</exception>
  [Pure]
  public static IAsyncExecutable<T1, T2> OrElse<T1, T2>(this IAsyncExecutable<T1, Optional<T2>> executable, AsyncFunc<T1, T2> other) {
  ...
  /// <exception cref="ArgumentNullException"><paramref name="other"/> is <see langword="null"/>.</exception>
  [Pure]
  public static IAsyncExecutable<Unit, T> OrElse<T>(this IAsyncExecutable<Unit, Optional<T>> executable, AsyncFunc<T> other) {
    return executable.OrElse(AsyncExecutable.Create(other));
  }
  ...
  /// <exception cref="ArgumentNullException"><paramref name="other"/> is <see langword="null"/>.</exception>
  [Pure]
  public static IAsyncExecutable<T, Unit> OrElse<T>(this IAsyncExecutable<T, Optional<Unit>> executable, AsyncAction<T> other) {
    return executable.OrElse(AsyncExecutable.Create(other));
  }
  ...
  /// <exception cref="ArgumentNullException"><paramref name="other"/> is <see langword="null"/>.</exception>
  [Pure]
  public static IAsyncExecutable<Unit, Unit> OrElse(this IAsyncExecutable<Unit, Optional<Unit>> executable, AsyncAction other) {
    return executable.OrElse(AsyncExecutable.Create(other));
  }
  ...
  /// <exception cref="ArgumentNullException"><paramref name="other"/> is <see langword="null"/>.</exception>
  [Pure]
  public static IAsyncExecutable<T1, T2> OrElse<T1, T2>(this IAsyncExecutable<T1, Optional<T2>> executable, Func<T1, T2> other) {
  ...
  /// <exception cref="ArgumentNullException"><paramref name="other"/> is <see langword="null"/>.</exception>
  [Pure]
  public static IAsyncExecutable<Unit, T> OrElse<T>(this IAsyncExecutable<Unit, Optional<T>> executable, Func<T> other) {
    return executable.OrElse(Executable.Create(other));
  }
  ...
  /// <exception cref="ArgumentNullException"><paramref name="other"/> is <see langword="null"/>.</exception>
  [Pure]
  public static IAsyncExecutable<T, Unit> OrElse<T>(this IAsyncExecutable<T, Optional<Unit>> executable, Action<T> other) {
    return executable.OrElse(Executable.Create(other));
  }
  ...
  /// <exception cref="ArgumentNullException"><paramref name="other"/> is <see langword="null"/>.</exception>
  [Pure]
  public static IAsyncExecutable<Unit, Unit> OrElse(this IAsyncExecutable<Unit, Optional<Unit>> executable, Action other) {
    return executable.OrElse(Executable.Create(other));
  }
