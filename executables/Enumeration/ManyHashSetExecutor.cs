...
public struct ManyHashSetExecutor<T1, T2>(IExecutor<T1, HashSet<T2>> executor, IEnumerator<T1> source) : IEnumerator<T2> {

  public T2 Current { get; private set; }
  object IEnumerator.Current => Current;

  private int _state;
  private HashSet<T2>.Enumerator _innerSource;
